      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Created boxes</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{activeShipments} active shipments</p>
          </CardContent>
        </Card>
      </div>
...
async function ShipperDashboard({ sessionUserId }: { sessionUserId: string }) {
  const [
    shipments,
    totalBoxes,
    openBoxes,
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Manage your shipments and picker links</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Your shipments</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Picker links</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            {shipments.length === 0 && (
              <p className="text-gray-500 text-center py-4">No shipments yet</p>
            )}
          </div>
        </CardContent>
      </Card>
...
async function PackerDashboard({ sessionUserId }: { sessionUserId: string }) {
  const [
    assignedShipments,
    totalBoxesPacked,
    recentBoxes
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Manage boxes and pack items efficiently</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Current shipments</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Boxes processed</p>
          </CardContent>
        </Card>
            ...
            {assignedShipments.map((link) => (
              <div key={link.id} className="border rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-gray-600">Items Picked</p>
                    <p className="font-medium">
        ...
        <CardContent>
          <div className="space-y-3">
            {recentBoxes.map((box) => (
              <div key={box.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{box.shipment.name}</p>
                </div>
                <div className="text-right">
                  <Badge 
            ...
            {recentBoxes.length === 0 && (
              <p className="text-gray-500 text-center py-4">No recent box activity</p>
            )}
          </div>
        </CardContent>
      </Card>
...
export default async function DashboardPage() {
  ...
  return (
    <Suspense fallback={<DashboardSkeleton />}>
      ...
      {session.user.role === "PACKER" && <PackerDashboard sessionUserId={session.user.id} />}
    </Suspense>
  )
}